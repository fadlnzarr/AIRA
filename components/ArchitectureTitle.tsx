      ...
      <div className="relative w-full aspect-[4/1] md:aspect-[5/1] max-h-[200px] flex items-center justify-center">
        ...
        >
          ...
          <g transform="translate(720, 100)">
             ...
             />
             <motion.circle cx="200" cy="-40" r="3" fill="white" initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ delay: 2.7 }} />
             ...
             />
             <motion.circle cx="200" cy="0" r="3" fill="white" initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ delay: 2.9 }} />
             ...
             />
             <motion.circle cx="200" cy="40" r="3" fill="white" initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ delay: 3.1 }} />
