...
function Scene() {
    ...
    const gl = useThree((s) => s.gl) // Access gl to get correct pixel ratio
    ...
    const getThemeColors = () => {
        switch (theme) {
            ...
            default:
                // Default to light theme colors since the site is now light theme
                return {
                    dotColor: '#000000', // Making dots visible on light bg
                    bgColor: '#FFFFFF',
                    dotOpacity: 0.1
                }
        }
    ...
    // Explicit type extension for JSX
    ...
    useFrame((state) => {
        ...
        // Update resolution on frame to handle resize smoothly
        // Check if uniforms exist and resolution value exists
        if (dotMaterial.uniforms.resolution) {
